...
import { ICalendarEntry } from "src/app/shared/models/ICalendarEntry";
...
export class CalendarPanelComponent implements OnInit {
  ...
  public entryToEdit: ICalendarEntry = null;
  ...
  public EditCalendarEntry(entry: ICalendarEntry) {
    this.creating = true; // Switch to 'create' view.
